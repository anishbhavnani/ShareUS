...
import com.share.in.main.MainActivity;
 ...
 */
public class TransferActivity extends Activity implements ChannelListener, DeviceListFragment.DeviceActionListener {
    ...
    public void onResume() {
        super.onResume();
        receiver = new WiFiDirectBroadcastReceiver(manager, channel, TransferActivity.this);
            ...
            case R.id.action_directDiscover:
                ...
                manager.discoverPeers(channel, new WifiP2pManager.ActionListener() {
                    ...
                    public void onFailure(int reasonCode) {
                        Toast.makeText(TransferActivity.this, "Discovery Failed : " + reasonCode,
                                Toast.LENGTH_SHORT).show();
                    }
                });
                return true;
