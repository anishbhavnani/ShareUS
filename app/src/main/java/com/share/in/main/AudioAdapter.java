    ...
    public  void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder.getItemViewType() == IMAGE_LIST) {;
         ...
         //   viewHolder.duration.setText(imageList.get(position).getDuration());
            ...
            if(AudioModel.filePath.contains(imageList.get(position).getPath()+"/")) {
        ...
        public ImageListViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                if(!AudioModel.filePath.contains(imageList.get(position).getPath()+"/")) {
                    ...
                    AudioModel.filePath.add(imageList.get(position).getPath() + "/");
                } else {
                    if (imageList != null) {
                        checkBox.setVisibility(View.INVISIBLE);
                        AudioModel.filePath.removeIf((String fpath) -> fpath.startsWith(imageList.get(position).getPath()));
                    }
                }
                send.setText("Send ("+(
