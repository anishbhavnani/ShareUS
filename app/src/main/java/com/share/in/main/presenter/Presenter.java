package com.share.in.main.presenter;
...
import com.share.in.main.model.FileArrayAdapter;
import com.share.in.main.model.Model;
...
public class Presenter implements LoaderManager.LoaderCallbacks<List<File>> {
    private UIFragment mView; //Our view.
    ...
    public Presenter(UIFragment mView) {
        this.mView = mView;
        mModel = new Model();
        mData = new ArrayList<>();
        init();
